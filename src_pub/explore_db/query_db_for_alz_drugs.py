...
class Neo4jDrugExporter:
    def __init__(self):
        setup_logging(log_file_prefix="logs/drugbank_export", processed_file="drugbank_export")

    def fetch_drugs_from_neo4j(self):
        """
        Fetch drug nodes with 'indication' property containing 'alzheim' (case insensitive) from Neo4j database.
    ...
    def run_export_pipeline(self, output_file_path):
        """
        ...
        try:
            ...
            drugs = self.fetch_drugs_from_neo4j()
...
if __name__ == "__main__":
    ...
    output_file_path = '/datasets/drugbank_drugs_alzheimers.csv'
    exporter = Neo4jDrugExporter()
    exporter.run_export_pipeline(output_file_path)